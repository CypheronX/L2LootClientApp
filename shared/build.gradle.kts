...
buildkonfig {
    ...
    defaultConfigs {
        ...
        buildConfigField(STRING, "GITHUB_RELEASE_REPO", "CypheronX/L2LootClientAppReleases")
    ...
    defaultConfigs("dev") {
        ...
        buildConfigField(STRING, "GITHUB_RELEASE_REPO", "CypheronX/L2LootClientAppTest")
